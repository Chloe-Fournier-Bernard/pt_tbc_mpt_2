...
const consent = {
  ...
  stimulus: `<div style="text-align: justify; max-width: 800px; margin: 0 auto;">
    ...
    <p>Participation in this study will involve completing a computer-based task involving pictures and text, followed by a short survey. Your involvement will require about 19 minutes. You will receive £ 4.55 GBP in exchange for your participation. To participate, you need to use a computer.</p>
...
const save_data = {
  type: jsPsychPipe,
  action: "save",
  experiment_id: "ceOaWqCVnrLC", // see DataPipe 
  filename: filename,
